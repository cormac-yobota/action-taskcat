> **_NOTE:_**  This is a fork of [ShahradR/action-taskcat](https://github.com/ShahradR/action-taskcat) as there's an [issue](https://github.com/ShahradR/action-taskcat/issues/350.) with the docker build.
